...
比如，用户名是bill，主机名是 home-machine，前缀就是bill@home-machine。
...
1969年，Ken Thompson 和 Dennis Riche 开发了第一版的 Unix。
...
用户可以通过bash命令的`--version`参数或者环境变量`$BASH_VERSION`，查看本机的 Bash 版本。
